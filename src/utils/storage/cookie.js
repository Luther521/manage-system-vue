...
import {storagePrefix} from 'src/utils/setting'
...
class Cookie {
  ...
  get (key) {
    ...
    // console.log('value',this.prefix + key, value)
    return value
  }
  ...
  set (key, value, options) {
    ...
    let expires = options.expires !== undefined ? options.expires : (this.defaults.expires || 0)
